...
type User struct {
	...
	Password  string         `json:"password" gorm:"password:varchar(255);not null" binding:"required,alphanum"`
	...
	PasswordConfirmation string `json:"password_confirmation" gorm:"-" binding:"required,alphanum,eqfield=password"`
}
